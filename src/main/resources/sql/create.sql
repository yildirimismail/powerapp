...
alter table role_user add constraint FK4320p8bgvumlxjkohtbj214qi foreign key (user_id) references user
...
INSERT INTO public.users2 (id, account_expired, account_locked, credentials_expired, email, enabled, password, username) VALUES (1, false, false, false, 'william@gmail.com', true, '{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi', 'admin');
INSERT INTO public.users2 (id, account_expired, account_locked, credentials_expired, email, enabled, password, username) VALUES (2, false, false, false, 'john@gmail.com', true, '{bcrypt}$2a$10$EOs8VROb14e7ZnydvXECA.4LoIhPOoFHKvVF/iBZ/ker17Eocz4Vi', 'user');